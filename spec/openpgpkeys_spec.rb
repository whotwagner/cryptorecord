...
describe Cryptorecord::Openpgpkeys do
 ...
 it "calling read_gpgkeyfile with nil should raise Cryptorecord::ArgumentError" do
   sshfp = Cryptorecord::Openpgpkeys.new(:uid => "hacky@hacktheplanet.com")
   expect{sshfp.read_gpgkeyfile(nil)}.to raise_error(Cryptorecord::ArgumentError)
 end
end
