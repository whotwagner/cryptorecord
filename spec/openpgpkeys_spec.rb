...
describe Cryptorecord::Openpgpkeys do
 ...
 it "set uid to a hash-object should raise Cryptorecord::InvalidType" do
   expect{sshfp = Cryptorecord::Openpgpkeys.new(:uid => Hash.new)}.to raise_error(Cryptorecord::InvalidType)
 end
end
